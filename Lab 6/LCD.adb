...
F:G$lcd_dat$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$lcd_puts$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$lcd_cmd$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$lcd_clear$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$lcd_goto$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$lcd_home$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$lcd_cursor$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$small_delay$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$large_delay$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$huge_delay$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llcd_init$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[r2]
S:Llcd_busy_wait$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[r2]
S:Llcd_dat$dat$1$1({1}SC:S),R,0,0,[r2]
S:Llcd_dat$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[r3]
S:Llcd_puts$string$1$1({3}DG,SC:S),R,0,0,[r2,r3,r4]
S:Llcd_puts$i$1$1({2}SI:S),R,0,0,[r5,r6]
S:Llcd_cmd$cmd$1$1({1}SC:S),R,0,0,[r2]
S:Llcd_cmd$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[r3]
S:Llcd_goto$addr$1$1({1}SC:S),R,0,0,[r2]
S:Llarge_delay$d$1$1({1}SC:S),R,0,0,[r2]
S:Lhuge_delay$d$1$1({1}SC:S),R,0,0,[r2]
S:Llcd_cursor$on$1$1({1}SB0$1:U),H,0,0
