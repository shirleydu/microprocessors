...
{	
	...
	printf("\033[2J");
	printf("Your Average Response Time is: %d\n\r", total/n);
	printf("Ready?\r\n");
	...
	while(!buttonPressed);
	//print average
	printf("Time in overflows: %d\n\r", overflows);
	total += overflows;
	printf("\033[0;0HYour Average Response Time is : %d\n\r", total/n);

	//wait for restart button press
	printf("\033[4;0HPush the button to restart!!\r\n");
	buttonPressed = 0;
	while(!buttonPressed);
}
