...
S:G$printTime$0$0({1}SB0$1:U),H,0,0
...
S:FPART2_1$_str_0$0$0({5}DA5,SC:S),D,0,0
S:FPART2_1$_str_1$0$0({19}DA19,SC:S),D,0,0
S:FPART2_1$_str_2$0$0({12}DA12,SC:S),D,0,0
