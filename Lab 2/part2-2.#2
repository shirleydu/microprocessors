...
void Timer2_Init()		//timer 2 init
{
	...
	RCAP2L = 0xD0;	//lowbit for sysclk/2	
	RCAP2H = 0x9E;	//highbit for sysclk/2
	//RCAP2L = 0xA0;		//lowbit for sysclk
	//RCAP2H = 0x3D;		//highbit for sysclk
...
{ 
	...
	//TMR2CN &= 0x7F;		//clears overflow flag
	TF2=0;
	TL2 =0xD0;
	TH2 =0x9E;
	if (overflows == 100 )
