...
S:Lmain$p$1$1({2}DX,SC:U),R,0,0,[r6,r7]
S:Lmain$mem$1$1({2}SI:S),R,0,0,[r2,r3]
S:Lmain$i$1$1({2}SI:S),R,0,0,[r4,r5]
...
S:Flab5_3$_str_0$0$0({5}DA5,SC:S),D,0,0
S:Flab5_3$_str_1$0$0({16}DA16,SC:S),D,0,0
S:Flab5_3$_str_2$0$0({38}DA38,SC:S),D,0,0
