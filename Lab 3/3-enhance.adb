...
F:G$sendChars$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$writeTop$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$writeBot$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$rowTop$0$0({2}SI:S),E,0,0
S:G$rowBot$0$0({2}SI:S),E,0,0
S:Lmain$input$1$1({1}SC:S),R,0,0,[r2]
S:Lmain$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[]
S:LsendChars$input$1$1({1}SC:S),R,0,0,[r2]
S:LwriteTop$c$1$1({1}SC:S),R,0,0,[r2]
S:LwriteTop$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[r3]
S:LwriteBot$c$1$1({1}SC:S),R,0,0,[r2]
S:LwriteBot$SFRPAGE_SAVE$1$1({1}SC:S),R,0,0,[]
...
S:L-null-$sendChars$4$4({2}DF,SI:S),C,0,0
S:G$sendChars$0$0({2}DF,SV:S),C,0,0
S:F3_enhance$_str_0$0$0({5}DA5,SC:S),D,0,0
S:F3_enhance$_str_1$0$0({8}DA8,SC:S),D,0,0
S:F3_enhance$_str_2$0$0({81}DA81,SC:S),D,0,0
S:F3_enhance$_str_3$0$0({9}DA9,SC:S),D,0,0
S:F3_enhance$_str_4$0$0({12}DA12,SC:S),D,0,0
S:F3_enhance$_str_5$0$0({8}DA8,SC:S),D,0,0
S:F3_enhance$_str_6$0$0({8}DA8,SC:S),D,0,0
S:F3_enhance$_str_7$0$0({5}DA5,SC:S),D,0,0
S:F3_enhance$_str_8$0$0({9}DA9,SC:S),D,0,0
