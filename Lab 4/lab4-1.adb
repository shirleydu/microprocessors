...
F:G$poll$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$average$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$average$0$0({2}DF,SI:U),Z,0,0,0,0,0
S:G$oldVals$0$0({32}DA16,SI:U),E,0,0
S:G$currentVal$0$0({2}SI:S),E,0,0
S:Lmain$i$1$1({2}SI:S),R,0,0,[r2,r3]
S:Lpoll$v$1$1({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:Lpoll$voltage$1$1({2}SI:S),E,0,0
S:Laverage$newVal$1$1({2}SI:U),E,0,0
S:Laverage$i$1$1({2}SI:S),E,0,0
S:Laverage$sum$1$1({2}SI:U),R,0,0,[r4,r5]
...
S:Flab4_1$_str_0$0$0({5}DA5,SC:S),D,0,0
S:Flab4_1$_str_1$0$0({17}DA17,SC:S),D,0,0
S:Flab4_1$_str_2$0$0({18}DA18,SC:S),D,0,0
S:Flab4_1$_str_3$0$0({23}DA23,SC:S),D,0,0
S:Flab4_1$_str_4$0$0({23}DA23,SC:S),D,0,0
