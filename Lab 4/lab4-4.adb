...
F:G$do_ADC$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$do_DAC$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$do_MAC$0$0({2}DF,SI:U),Z,0,0,0,0,0
...
F:G$MAC_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$MAC_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:G$oldOut$0$0({2}SI:U),E,0,0
S:G$oldIn$0$0({2}SI:U),E,0,0
S:G$olderIn$0$0({2}SI:U),E,0,0
S:G$output$0$0({2}SI:U),E,0,0
S:G$input$0$0({2}SI:U),E,0,0
S:Lmain$high$1$1({1}SC:S),R,0,0,[]
S:Lmain$low$1$1({1}SC:S),R,0,0,[]
S:Ldo_ADC$ADC_val$1$1({2}SI:U),R,0,0,[r2,r3]
S:Ldo_MAC$voltage$1$1({2}SI:S),E,0,0
S:Ldo_MAC$result$1$1({2}SI:U),R,0,0,[r2,r3]
...
S:Flab4_4$_str_0$0$0({5}DA5,SC:S),D,0,0
S:Flab4_4$_str_1$0$0({20}DA20,SC:S),D,0,0
S:Flab4_4$_str_2$0$0({17}DA17,SC:S),D,0,0
